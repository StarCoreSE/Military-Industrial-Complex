...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef BALLER_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            {
                AmmoRound = "BALLER_bounce", // AmmoRound field of the ammo to spawn.
        ...
        private AmmoDef BALLER_ammo_bounce => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "BALLER_bounce", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    ParticleScale = 1f,
                    CustomParticle = "", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "BALLERcomplete", // SubtypeID from your Audio SBC, not a filename
                    Shape = Round, // Round or Diamond shape.  Diamond is more performance friendly.
                },
            },
            Ewar = new EwarDef
